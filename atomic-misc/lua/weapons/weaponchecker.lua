...
File: addons/atomic-misc/lua/weapons/weaponchecker.lua
Size: 10387 B
...
function SWEP:PrimaryAttack()
    ...
    self:PrintWeapons(ent, ent:getDarkRPVar( "HasGunlicense" ) and ent:Nick() .. "'s licensed weapons:" or DarkRP.getPhrase("persons_weapons", ent:Nick()))
end
