...
File: addons/atomic-misc/lua/improvedstacker/localization.lua
Size: 63699 B
...
localify.Bind( "fr", prefix.."0",                     "Stacker - Amélioré" )
...
-- Tool Settings
localify.Bind( "pl", prefix.."0",                     "Stacker - Ulepszony" )
...
-- Tool Settings
localify.Bind( "zh-cn", prefix.."0",                     "叠加器 - 改进" )
